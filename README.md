...
CREATE TABLE `orbis_all_data` (
  ...
  `cnty_iso` VARCHAR(255) DEFAULT NULL,
  `bvd_id` VARCHAR(255) DEFAULT NULL,
  `guo_bvd_id` VARCHAR(255) DEFAULT NULL,
  `guo_name` VARCHAR(255) DEFAULT NULL,
  `entity_type` VARCHAR(255) DEFAULT NULL,
  `category` VARCHAR(255) DEFAULT NULL,
  `operating_revenue_usd` VARCHAR(255) DEFAULT NULL,
  `nace` VARCHAR(255) DEFAULT NULL,
  `nace_primary` VARCHAR(255) DEFAULT NULL,
  `nace_secondary` VARCHAR(255) DEFAULT NULL,
  `previous_company_name` VARCHAR(255) DEFAULT NULL,
  `no_subs` VARCHAR(255) DEFAULT NULL,
  `subs_level` VARCHAR(255) DEFAULT NULL,
  `subs_name` VARCHAR(255) DEFAULT NULL,
  `subs_bvd_id` VARCHAR(255) DEFAULT NULL,
  `subs_cnty_iso` VARCHAR(255) DEFAULT NULL,
  `subs_nace` VARCHAR(255) DEFAULT NULL,
  `subs_direct` VARCHAR(255) DEFAULT NULL,
  `subs_total` VARCHAR(255) DEFAULT NULL,
  `subs_status` VARCHAR(255) DEFAULT NULL,
  `subs_info_source` VARCHAR(255) DEFAULT NULL,
  `subs_info_posbl_change` VARCHAR(255) DEFAULT NULL,
  `subs_city` VARCHAR(255) DEFAULT NULL,
  `subs_type` VARCHAR(255) DEFAULT NULL,
  `subs_info_date` VARCHAR(255) DEFAULT NULL,
  `subs_operating_revenue_usd` VARCHAR(255) DEFAULT NULL,
  `subs_no_employees` VARCHAR(255) DEFAULT NULL,
  `subs_total_assets_usd` VARCHAR(255) DEFAULT NULL,
  `bvb_indep_indic` VARCHAR(255) DEFAULT NULL,
  `guo_nace` VARCHAR(255) DEFAULT NULL,
  `guo_direct` VARCHAR(255) DEFAULT NULL,
  `guo_total` VARCHAR(255) DEFAULT NULL,
  `guo_no_employees` VARCHAR(255) DEFAULT NULL,
  `guo_city` VARCHAR(255) DEFAULT NULL,
  `latitude` VARCHAR(255) DEFAULT NULL,
  `longitude` VARCHAR(255) DEFAULT NULL,
  `info_date_operating_revenue` VARCHAR(255) DEFAULT NULL,
  `net_income_eur` VARCHAR(255) DEFAULT NULL,
  `net_income_usd` VARCHAR(255) DEFAULT NULL,
  `info_date_total_assets` VARCHAR(255) DEFAULT NULL,
  `no_employees` VARCHAR(255) DEFAULT NULL,
  `date_info_no_employees` VARCHAR(255) DEFAULT NULL,
  `total_assets_eur` VARCHAR(255) DEFAULT NULL,
  `total_assets_usd` VARCHAR(255) DEFAULT NULL,
  `current_market_eur` VARCHAR(255) DEFAULT NULL,
  `current_market_usd` VARCHAR(255) DEFAULT NULL,
  `main_exchange` VARCHAR(255) DEFAULT NULL,
  `status_list` VARCHAR(255) DEFAULT NULL,
  `bvd_indep_indic` VARCHAR(255) DEFAULT NULL,
  `no_companies_corp_group` VARCHAR(255) DEFAULT NULL,
  `no_recorded_subs` VARCHAR(255) DEFAULT NULL,
  `main_production_site` VARCHAR(255) DEFAULT NULL,
  `main_distribution_site` VARCHAR(255) DEFAULT NULL,
  `main_domestic_cnty` VARCHAR(255) DEFAULT NULL,
  `main_foreign_cnty` VARCHAR(255) DEFAULT NULL
