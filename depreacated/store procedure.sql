...
*/
 UPDATE layer2_couples_from_three_companies_in_the_matrix_pairs AS A
 INNER JOIN tmp_comp_subs2 AS B
...
*/
 ...
 SELECT subs_bvd_id FROM layer2_couples_from_three_companies_in_the_matrix_pairs 
 WHERE subs_bvd_id NOT IN ( SELECT subs_bvd_id FROM layer2_couples_from_three_companies_in_the_matrix_pairs 
 WHERE selected = 1 GROUP BY subs_bvd_id)
 GROUP BY subs_bvd_id;

 DELETE A FROM layer2_couples_from_three_companies_in_the_matrix_pairs A                                                                                                                 
 INNER JOIN no_relation_all_zero B ON                                                                                                       
...
*/
 ...
 FROM layer2_couples_from_three_companies_in_the_matrix_pairs AS A
...
*/
 ...
 SELECT subs_bvd_id, bvd_id1, bvd_id2, selected FROM layer2_couples_from_three_companies_in_the_matrix_pairs
 WHERE subs_bvd_id IN (SELECT subs_bvd_id FROM layer2_couples_from_three_companies_in_the_matrix_pairs                                             
 WHERE selected = 1 
 GROUP BY subs_bvd_id
...
-- SUBS WITH ONLY PAIRS, AND PUT THIS INTO THE SET OF SUBS TO BE TREATED
 INSERT INTO `1_1_two_subs_selected_to_be_treated`
 SELECT subs_bvd_id,bvd_id1,bvd_id2,selected FROM layer2_couples_from_three_companies_in_the_matrix_pairs WHERE
 ...
 INSERT INTO `layer2_clear_subs`
 SELECT subs_bvd_id,bvd_id2 AS selected_bvd_id FROM layer2_couples_from_three_companies_in_the_matrix_pairs WHERE
 subs_bvd_id IN ( SELECT subs_bvd_id FROM (SELECT subs_bvd_id,bvd_id1,bvd_id2  
 FROM layer2_couples_from_three_companies_in_the_matrix_pairs                                             
 WHERE selected = 1 GROUP BY subs_bvd_id,bvd_id2) AS A
 ...
 DELETE A FROM layer2_couples_from_three_companies_in_the_matrix_pairs AS A
 INNER JOIN `layer2_clear_subs` AS B ON A.subs_bvd_id = B.subs_bvd_id;
